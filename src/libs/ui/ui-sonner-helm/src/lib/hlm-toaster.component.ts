...
@Component({
  ...
  standalone: true,
  imports: [NgxSonnerToaster, HlmSpinnerComponent],
  template: `
    <ngx-sonner-toaster
      ...
      [dir]="dir()"
      [style]="userStyle()">
      <hlm-spinner class="h-4 w-4" loading-icon />
    </ngx-sonner-toaster>
  `,
  styles: `
    ::ng-deep :is(hlm-spinner, hlm-icon) {
...
export class HlmToasterComponent {
  ...
  public readonly duration = input<ToasterProps['duration'], number | string>(3000, {
